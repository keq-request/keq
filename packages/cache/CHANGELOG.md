...
- f90ac50: **BREAKING CHANGE:** group all packages under the @keq-request scope
...
- 8c9d7a1: **BREAKING CHANGE:** `onNetworkResponse` has been removed, please use `.on('cache:update', callback)` instead.

### Minor Changes

- 8c9d7a1: **Feat:** Add `onCacheGet`, `onCacheSet`, `onCacheRemove`, `onCacheEvict` and `onCacheExpired` hook for `MemoryStorage` and `IndexedDBStorage`.
- 8c9d7a1: **Feat:** Add `cache:hit`, `cache:miss` and `cache:update` to keq events.

### Patch Changes

- 8c9d7a1: **Feat:** `pattern` accept boolean and defaults to true
- 8c9d7a1: **Fix:** unable to cache modified `ctx.res`.
- Updated dependencies [8c9d7a1]
- Updated dependencies [8c9d7a1]
- Updated dependencies [8c9d7a1]
- Updated dependencies [8c9d7a1]
- Updated dependencies [8c9d7a1]
- Updated dependencies [e989a53]
- Updated dependencies [8c9d7a1]
- Updated dependencies [8c9d7a1]
- Updated dependencies [8c9d7a1]
- Updated dependencies [8c9d7a1]
