...
- db4b8b8: **BREAKING CHANGE:** Rename the command keq-cli to keq.
- 8c9d7a1: **BREAKING CHANGE:** the request option in keqrc config removed.
...
- 8c9d7a1: **Fix:** avoid conflicts between the interface name of operation and the schema name of components
