...
- 8c9d7a1: **BREAKING CHANGE:** Add an options to control query serialization.
...
- 8c9d7a1: **BREAKING CHANGE:** Prevent modification of the immutable properties of the context.
- 8c9d7a1: **BREAKING CHANGE:** `.params(key, value)` will not encode value automatically, please replace it with `.params(key, encodeURIComponent(value)`, if necessary.
- 8c9d7a1: **BREAKING CHANGE:** refactor event emitter. `fetch` event has been removed, please use `fetch:before`/`fetch:after` instead.
...
- e989a53: **BREAKING CHANGE:** Strictly adhere to URI template implementation (RFC 6570 compliant). Therefore, ':id' is no longer supported.
- 8c9d7a1: **BREAKING CHANGE:** change KeqRequest from interface to class.
...
- 8c9d7a1: **BREAKING CHANGE:** Refactoring keq middlewares
...
- 8c9d7a1: **BREAKING CHANGE:** Drop support node@18.

### Minor Changes

- 8c9d7a1: **Feat:** add `.headers` as an alias for `.set`
- 8c9d7a1: **Feat:** `.attach` can take multiple files.

### Patch Changes

- 8c9d7a1: optimize code suggestions
