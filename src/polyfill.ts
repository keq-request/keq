...
export const fetch: typeof global.fetch = isBrowser ? window.fetch.bind(window) : require('node-fetch').default
// export const fetch: typeof global.fetch = cFetch
export const Headers: typeof global.Headers = isBrowser ? window.Headers : require('node-fetch').default.Headers
export const Response: typeof global.Response = isBrowser ? window.Response : require('node-fetch').Response
